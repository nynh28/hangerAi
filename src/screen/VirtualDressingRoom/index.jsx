...
const VirtualDressingRoom = () => {
    ...
    return (<>
        ...
        >
            ...
            >
                <CommonStyles.Box
                    sx={{ width: openModal === true ? '60%' : '92%', transition: "width 0.5s ease-in-out" }}
                >
                    <CommonStyles.Box
                        sx={{
                            paddingTop:"5px",
                    ...
                    sx={{height:"94%"}}
                    >
                        <img src="https://icdn.24h.com.vn/upload/2-2021/images/2021-06-10/Phat-hien-baaca0eb0e33dc4f9d45910b8c86623f0144cea0fe0c2093c5-1623311033-423-width1000height1499.jpg" width={ openModal ===true ? "38%": "30%"} height="98%" style={{borderRadius:"6px"}} />
                    </CommonStyles.Box>
                </CommonStyles.Box>
                <CommonStyles.Box
                    sx={{
